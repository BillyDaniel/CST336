...
function displayDevices(){
    ...
    $records = $stmt->fetchAll(PDO::FETCH_ASSOC);
     ...
     foreach ($records as $record) {
        ...
        echo  "<p> " . $record['deviceName'] . " " . $record['deviceType'] . " " .
              $record['price'] .  "  " . $record['status'] . 
              "<a target='checkoutHistory' href='checkoutHistory.php?deviceId=".$record['deviceId']."'> Checkout History </a></p>";
