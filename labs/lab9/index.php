...
?>
            ...
            <div id="carouselwrap">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item">
                      <img class="d-block img-fluid" src="img/samantha.jpg" alt="Eigth slide">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block img-fluid" src="img/ted.jpg" alt="Nineth slide">
                    </div>
                    <div class="carousel-item">
            ...
            <br/><br/>
            <a class="btn btn-primary" href="adoption.php" role="button">Adopt Now!</a>
            <br/><br/>
            <hr>
